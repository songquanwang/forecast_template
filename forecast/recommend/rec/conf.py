...
plans_features = ['first_mode',
                  'max_dist', 'max_dist_mode',
                  'max_dj', 'max_eta',
                  'max_eta_mode', 'max_price', 'max_price_mode', 'max_sd', 'max_sd_dj',
                  'mean_dist', 'mean_dj', 'mean_eta', 'mean_price', 'mean_sd',
                  'mean_sd_dj', 'min_dist', 'min_dist_mode', 'min_dj', 'min_eta',
                  'min_eta_mode', 'min_price', 'min_price_mode', 'min_sd', 'min_sd_dj',
                  'mode_feas_0', 'mode_feas_1', 'mode_feas_10', 'mode_feas_11',
                  'mode_feas_2', 'mode_feas_3', 'mode_feas_4', 'mode_feas_5',
                  'mode_feas_6', 'mode_feas_7', 'mode_feas_8', 'mode_feas_9',
                  'mode_texts', 'sid', 'std_dist', 'std_dj', 'std_eta', 'std_price',
                  'std_sd', 'std_sd_dj', 'svd_mode_0', 'svd_mode_1', 'svd_mode_2',
